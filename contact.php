<?php include('./assets/partials/header.php')  ?>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/images/1.jpg');">
          ...
          <div class="col-lg-6">
            <form id="contact-form"  action="#" method="post" role="form" class="php-email-form" >
              ...
              <div class="my-3">
                ...
                <div id="mail-success" class="sent-message">
							Thank you. The Mailman is on His Way :)
						</div>
						<div id="mail-fail" class="error-message">
